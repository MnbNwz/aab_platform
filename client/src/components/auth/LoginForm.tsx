    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">Sign in to your AAS account</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            {errors.password && (
              <p className="mt-1 text-red-300 text-xs">{String(errors.password.message)}</p>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-orange-300 hover:text-orange-200 text-sm">
              Forgot Password?
            </Link>
          </div>
          ...
          <button
            ...
            className="w-full py-3 px-4 rounded-lg font-semibold text-white transition-all duration-200 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
        ...
        <div className="mt-6 text-center">
          <p className="text-white/80">
            ...
            <Link to="/register" className="text-orange-300 hover:text-orange-200 font-medium">
              Sign Up
            </Link>
          </p>
        </div>
